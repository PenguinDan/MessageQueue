...
int main() {
    ...
    int MESSAGE_SIZE = retrieveMessageSize(receivedMessage);
    ...
    while(receivedMessagesCount < 5000) {
        cout << "Receiver 2 now waiting for a message:" << endl; 
        ...
        msgrcv(messageQueueId, (struct buffer *)&receivedMessage, MESSAGE_SIZE,
